...
app.use(express.static(path.join(__dirname, 'public'), {
  ...
  setHeaders(res, filePath) {
    // Never cache HTML — changes must be visible immediately after redeploy
...
// Serve APK from root
app.get('/VTechOTP.apk', (req, res) => {
  res.download(path.join(__dirname, 'VTechOTP.apk'), 'VTechOTP.apk');
});
